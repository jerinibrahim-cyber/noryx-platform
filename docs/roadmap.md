...
**Current baseline:** `main` at `e2c52ac8ed0c42789e3f8657afe80bced6ad4bd9` — Tax/VAT Phase 7 (VAT Position Detail / Source-Document Drill-Down) is implemented, verified, and delivered to `main`. See `docs/work-items/tax-vat-phase-7-vat-position-detail-drill-down/COMPLETION_REPORT.md` for the full verification record.
...
**Current work item:** Integration of repository reverification, cleanup, and governance (`chore/integrate-repository-cleanup-2026-09`).
