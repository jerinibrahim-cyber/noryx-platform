...
import { BankCashAccountStatementQueryDto } from "./bank-cash-account-statement-query.dto";

async function validateDto(input: Record<string, unknown>) {
  const dto = plainToInstance(BankCashAccountStatementQueryDto, input);
  return validate(dto);
}

describe("BankCashAccountStatementQueryDto", () => {
