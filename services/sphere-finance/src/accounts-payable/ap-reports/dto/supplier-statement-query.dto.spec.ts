...
import { SupplierStatementQueryDto } from "./supplier-statement-query.dto";

async function validateDto(input: Record<string, unknown>) {
  const dto = plainToInstance(SupplierStatementQueryDto, input);
  return validate(dto);
}

describe("SupplierStatementQueryDto", () => {
